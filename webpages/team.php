...
<head>
    <title>Welkom bij Karel Bolbloemen B.V. - Team</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="welkom-content text-center">
                        <p>Aan deze pagina wordt nog gewerkt. Klik <a href="../webpages/index.php">hier</a> om terug te gaan naar de homepagina.</p>
                    </div>
                </div>
            </div>
        </div>
